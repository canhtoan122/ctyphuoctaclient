...
export default function HCMToGB() {
  ...
  let caculateMoney = () => {
    let result = 0;
    result = parseInt(HCM) + parseInt(station);
    if (isNaN(result)) {
    ...
    <div>
      <div className="breadcrumb">
        ...
        <div className="breadcrumb_redirect">
          ...
          <span>Vận Chuyển Hàng Từ Kho Sài Gòn tới Ga Giáp Bát</span>
        </div>
      </div>
      <main>
        <div className="container">
          <div className="transport_detail">
            ...
            <div className="transport_detail_input">
              <input type="text" placeholder="Tiền kho đến ga Sóng Thần" onChange={handleHCMMoneyChange}/>
              <i>đ</i>
