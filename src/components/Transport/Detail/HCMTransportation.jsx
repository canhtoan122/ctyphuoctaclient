...
export default function HCMTransportation() {
    ...
    <div>
      <div className="breadcrumb">
        ...
        <div className="breadcrumb_redirect">
          ...
          <span>
            Vận Chuyển Hàng Từ Kho Sài Gòn tới các tỉnh thành miền nam
          </span>
        </div>
      </div>
      <main>
        <div className="container">
          <div className="transport_detail">
            ...
            <div className="transport_detail_input">
              <input type="text" placeholder="Tiền kho đến ga Sóng Thần" onChange={handleMoneyChange}/>
              <br />
