...
export default function StationToStation() {
    ...
    <div>
      <div className="breadcrumb">
        ...
        <div className="breadcrumb_redirect">
          ...
          <span>Vận Chuyển Hàng Từ Ga Sài Gòn tới Ga Hà Nội</span>
        </div>
      </div>
      <main>
        <div className="container">
          <div className="transport_detail">
            ...
            <div className="transport_detail_input">
              <input type="text" placeholder="Số tiền" onChange={handleMoneyChange} />
              <i>đ</i>
              <button onClick={caculateMoney}>Thành Tiền</button>
              <p id="result"> Số tiền</p>
            </div>
            <table
              className='transport_detail_table'
            >
              <thead>
                <tr>
                  <th>Nơi Đi</th>
